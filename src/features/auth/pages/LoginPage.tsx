...
function StatCard({
  ...
  return (
    <div className="flex flex-col gap-0.5">
      ...
      <span
        className={`text-2xl font-bold tracking-tight ${highlight ? 'text-emerald-300' : 'text-white'}`}
      >
        {value}
      </span>
    </div>
      ...
      <div className="animated-gradient relative hidden w-1/3 shrink-0 flex-col justify-between overflow-hidden p-10 lg:flex">
        ...
        <div className="relative flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-blue-200">
            Nền tảng doanh nghiệp đạt chuẩn ISO 27001
          </span>
        </div>
      </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    {...register('username')}
                    className={`w-full rounded-lg border bg-gray-50 py-2.5 pl-9 pr-4 text-sm text-gray-900 placeholder-gray-400 outline-none transition focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-500/20 ${
                      errors.username
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••••••"
                    {...register('password')}
                    className={`w-full rounded-lg border bg-gray-50 py-2.5 pl-9 pr-10 text-sm text-gray-900 placeholder-gray-400 outline-none transition focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-500/20 ${
                      errors.password
                        ? 'border-red-400 focus:border-red-500 focus:ring-red-500/20'
                        : 'border-gray-300'
                    }`}
          ...
          <div className="mt-4 flex items-start gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3.5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                Mọi truy cập đều được ghi lại và mã hóa theo thời gian thực.
              </p>
            </div>
          </div>

          <p className="mt-4 text-center text-[11px] leading-relaxed text-gray-400">
            Chỉ dành cho người dùng được ủy quyền. Mọi hành vi truy cập trái phép đều bị giám sát và
            xử lý theo quy định bảo vệ dữ liệu y tế hiện hành.
          </p>

          <div className="mt-6 flex items-center justify-center gap-4">
            {['Chính sách bảo mật', 'Điều khoản sử dụng', 'Trạng thái hệ thống'].map(
              (link, i, arr) => (
